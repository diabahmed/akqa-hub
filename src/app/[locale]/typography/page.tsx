          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="bg-card space-y-3 rounded-lg border p-6">
              ...
              <p className="font-body text-muted-foreground text-sm">
                Display font for large, attention-grabbing headlines and hero sections. Use
            ...
            <div className="bg-card space-y-3 rounded-lg border p-6">
              ...
              <p className="font-body text-muted-foreground text-sm">
                Editorial serif font for titles, headings, and creating typographic hierarchy.
                Elegant and refined.
              </p>
              <div className="space-y-1">
                <p className="font-body text-xs font-semibold tracking-wider uppercase">
            ...
            <div className="bg-card space-y-3 rounded-lg border p-6 md:col-span-2">
              ...
              <p className="font-body text-muted-foreground text-sm">
                Developer-focused monospace font for code blocks, technical content, and inline
                code. Designed for extended coding sessions.
              </p>
              <div className="space-y-1">
                <p className="font-body text-xs font-semibold tracking-wider uppercase">
                  Available Weights
              ...
              content={
                <>
                  <p>
                    ...
                    careful selection and implementation of typefaces can make the difference
                    between a good design and a great one.
                  </p>

                  <h2>Why Typography Matters</h2>
                  <p>
                    Good typography guides the reader&apos;s eye, creates hierarchy, and makes
                    content more digestible. It&apos;s not just about choosing fonts—it&apos;s about
                    creating a harmonious reading experience that respects the reader&apos;s time
                    and attention.
                  </p>
                  ...
                  <blockquote className="border-primary text-muted-foreground my-6 border-l-4 pl-4 italic">
                    ...
                    form, and thus with an independent existence.&rdquo;
...
<code className="font-mono">code</code>`}</code>
                  ...
                  <p>
                    Maintain consistency throughout your application. Use display fonts sparingly
                    for maximum impact. Ensure sufficient contrast between text and background.
                    Consider line length and spacing for optimal readability.
                  </p>
                </>
              }
            />
            ...
            <div className="bg-card space-y-3 rounded-lg border p-6">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-body text-muted-foreground text-sm">
                    Reserve FK Display for hero sections and major headlines only. Overuse
                    diminishes impact.
                  </p>
                </div>
              </div>
